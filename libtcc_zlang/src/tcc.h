...
typedef struct Sym {
    ...
    struct Sym *fwd; /* forward a symbol to another symbol */
} Sym;
...
struct TCCState {
    ...
    Sym* hierarchy_stack[200]; // support up to 200 depth, realistically we expect to get nowhere near this
    uint8_t hierarchy_stack_pointer;
