...
{
  return tcc_new_with_defines(1);
}

LIBTCCAPI TCCState *tcc_new_with_defines(int add_default_defines)
{
    TCCState *s;
...
# endif /* TCC_MUSL */
      ...
      // moved from tcc_set_output_type to here
      //
